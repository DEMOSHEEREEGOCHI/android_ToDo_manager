...
public class NetClient {
    ...
    public static void patchToDo(String id, JsonObject jsonObject, NetClientListener<JsonObject> netClientListener){
        instance.routes.patchToDo(id, jsonObject).enqueue(createCallback(netClientListener));
    }
}
